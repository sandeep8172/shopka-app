    ...
    return (
        <div className="sidebar_wrapper">
            <div className="top_list">
                <h2><i class="fa-solid fa-caret-down"></i>Departments</h2>
                <ul>
                    <li className="categoies"> <i class="fa-solid fa-chevron-right "></i>All Categories</li>
                    <li className="ecommerce">Ecommerce patterns</li>
                    <li><i class="fa-solid fa-chevron-down "></i> Electronics</li>
                    <li className="cellPhone"><i class="fa-solid fa-chevron-down "></i>Cell Phones & Smartphones</li>
                    ...
                    <li className="show_more">Show More <i class="fa-solid fa-chevron-down "></i></li>
                    <li><i class="fa-solid fa-chevron-right"></i>Business & Industrial</li>
                    <li><i class="fa-solid fa-chevron-right"></i>Computers</li>
                    <li><i class="fa-solid fa-chevron-right"></i>Consumer Electronics</li>
                    <li><i class="fa-solid fa-chevron-right"></i>Home & Garden</li>
                    <li><i class="fa-solid fa-chevron-right"></i>Collectibles</li>
                    <li className="expand">Expand</li>
                </ul>
            </div>
            <p className="collap">Collapsed filter <i class="fa-solid fa-chevron-down "></i></p>
            <div className="middle_list">
                <p className="expend">Expanded filters <i class="fa-solid fa-chevron-up"></i></p>
                ...
                <p className="dropdown_text_middle"><input type={"checkbox"} /> price: Low <i class="fa-solid fa-arrow-right-long"></i> High</p>
                <p className="dropdown_text_middle"><input type={"checkbox"} /> price: High <i class="fa-solid fa-arrow-right-long"></i> Low</p>
            </div>
            <div className="bottom_list">
                <p className="year">Year Of Manufacturing<i class="fa-solid fa-chevron-up"></i></p>
